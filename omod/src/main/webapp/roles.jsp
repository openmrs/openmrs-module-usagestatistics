...
<openmrs:require privilege="View Usage Statistics" otherwise="/login.htm" redirect="/module/usagestatistics/roles.htm"/>
...
<b class="boxHeader">
	<spring:message code="usagestatistics.roles.title"/>
</b>
<form method="get" class="box">
	...
	<table cellpadding="2" cellspacing="0" width="100%">
		<tr>
			<th><spring:message code="usagestatistics.results.role"/></th>
