...
/**
 * View to render location based usage data as a comma separated values
 */
public class StatsLocationsCSVView extends AbstractExportableStatsCSVView {
	
	protected static final Log log = LogFactory.getLog(StatsLocationsCSVView.class);
	...
	protected String getFilename(Map<String, Object> model) {
		return "locations" + super.getFilename(model);
	}
	...
	protected String getHeaderRow() {
		return "Location,Active Users,All Usages,Creates,Encounters,Updates,Voids,Last usage";
	}
