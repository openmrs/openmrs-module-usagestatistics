 ...
 */
public class StatsRolesController extends ExportableStatsQueryController {
	
	protected static final Log log = LogFactory.getLog(StatsRolesController.class);
	...
	protected void augmentModel(Map<String, Object> model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<Object[]> stats = svc.getRolesStats(getFromDate(), getUntilInclusiveDate(), getLocation(), usageFilter);	
