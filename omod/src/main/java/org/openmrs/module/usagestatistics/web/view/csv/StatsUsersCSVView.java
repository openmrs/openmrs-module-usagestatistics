...
/**
 * View to render user based usage data as a comma separated values
 */
public class StatsUsersCSVView extends AbstractExportableStatsCSVView {
	
	protected static final Log log = LogFactory.getLog(StatsUsersCSVView.class);
	...
	protected String getFilename(Map<String, Object> model) {
		return "users" + super.getFilename(model);
	}
	...
	protected String getHeaderRow() {
		return "User,All Usages,Creates,Encounters,Updates,Voids,Last usage";
	}
